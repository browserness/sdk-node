...
export class Resources {
     ...
     *
     * @example
     *     await client.resources.getResourceLimits()
     */
    public getResourceLimits(requestOptions?: Resources.RequestOptions): core.HttpResponsePromise<Record<string, any>> {
        return core.HttpResponsePromise.fromPromise(this.__getResourceLimits(requestOptions));
    }

    private async __getResourceLimits(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BrowsernessApiTimeoutError("Timeout exceeded when calling GET /limits.");
            case "unknown":
                throw new errors.BrowsernessApiError({
